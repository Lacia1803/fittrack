...
export default function HomePage() {
  ...
  const [emailMsg, setEmailMsg] = useState(
    "Không spam. Mời dùng thử sẽ gửi trong 24 giờ.",
  );
  ...
  return (
    <main className="min-h-screen bg-[#090d16] text-[#f3f6ff] relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="container mx-auto px-6 py-6 md:py-12 relative z-10 flex-1 flex flex-col justify-center max-w-6xl">
        ...
        <header className="flex items-center justify-between mb-12 md:mb-16">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-[0.18em] uppercase text-white">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth/login">
              <Button
                variant="ghost"
                className="text-slate-300 hover:text-white hover:bg-slate-800/40 text-xs sm:text-sm"
              >
                Đăng nhập
              </Button>
            </Link>
            <Link href="/auth/register">
              <Button className="bg-orange-500 hover:bg-orange-600 text-black text-xs sm:text-sm font-bold px-4 py-2 rounded-full shadow-lg shadow-orange-500/20 active:scale-95 transition-transform">
                Dùng thử ngay
              </Button>
            </Link>
          </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16 md:mb-24">
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <p className="text-base sm:text-lg text-slate-400 leading-relaxed max-w-xl">
              Ghi từng set với rest timer, theo dõi macro dinh dưỡng và nhận tư
              vấn từ AI Coach — tất cả trong một hệ sinh thái tập luyện chuẩn
              premium.
            </p>
            <div className="flex flex-wrap gap-4 pt-2">
              <Link href="/dashboard">
                <Button
                  size="lg"
                  className="bg-orange-500 hover:bg-orange-600 text-black font-semibold px-8 py-5 rounded-full shadow-xl shadow-orange-500/25 active:scale-95 transition-transform"
                >
                  Xem dashboard
                </Button>
              </Link>
              <Link href="/dashboard/sessions/new">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-slate-800 bg-slate-900/40 hover:bg-slate-900 text-slate-300 hover:text-white px-8 py-5 rounded-full"
                >
                  Vào workout log
                </Button>
              </Link>
            ...
            <div className="pt-4 max-w-md">
              ...
              <div className={`text-xs mt-2 min-h-[18px] ${emailMsgColor}`}>
                {emailMsg}
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-b from-white/8 to-white/2 border border-white/12 rounded-[20px] p-6 shadow-2xl backdrop-blur-md space-y-5">
              ...
              <div className="space-y-3.5 pt-2">
                <div className="flex justify-between items-center text-xs font-mono text-slate-400">
                  ...
                  <strong className="text-white font-semibold">
                    Lat Pulldown · Set 3/5
                  </strong>
                </div>
                <div className="flex justify-between items-center text-xs font-mono text-slate-400">
                  <span>AI Coach</span>
                  <strong className="text-orange-500 font-semibold flex items-center gap-1">
                    <Sparkles className="h-3 w-3" /> Giữ tempo 2-1-2 để tối ưu
                    lưng
                  </strong>
                </div>
                <div className="flex justify-between items-center text-xs font-mono text-slate-400">
        ...
        <section id="features" className="pt-12 mb-16 md:mb-24">
          <div className="text-center max-w-xl mx-auto mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-white">
              Chức năng thiết kế cho Athlete
            </h2>
            <p className="text-slate-400 text-sm mt-2">
              Mọi công cụ bạn cần để theo dõi thể hình một cách chuyên nghiệp.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                title: "Per-set workout logs + rest timer",
                desc: "Ghi từng set theo thời gian thực, tự động nhắc nghỉ giữa set để giữ hiệu suất ổn định.",
                icon: Dumbbell,
              },
              {
                title: "Progressive overload charts",
                desc: "Biểu đồ khối lượng tuần tự động, giúp bạn tăng tải có kiểm soát.",
                icon: Zap,
              },
              {
                title: "Contextual AI Coach",
                desc: "AI hiểu lịch sử tập, nhịp nghỉ và mục tiêu để đưa lời khuyên chuẩn ngữ cảnh.",
                icon: Cpu,
              },
              {
                title: "Nutrition calculator",
                desc: "Tính macro theo mục tiêu tăng cơ/giảm mỡ với gợi ý bữa ăn linh hoạt.",
                icon: Layers,
              },
              {
                title: "Offline sync & PWA",
                desc: "Ghi log offline, đồng bộ lại khi có mạng — sẵn sàng mọi nơi.",
                icon: RefreshCw,
              },
            ].map((f, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-b from-white/8 to-white/2 border border-white/12 p-6 rounded-[20px] shadow-lg backdrop-blur-md flex flex-col justify-between min-h-[180px] hover:border-orange-500/30 transition-all duration-300"
              >
                <div>
        ...
        <section id="ecosystem" className="mb-16 md:mb-24">
          <div className="text-center max-w-xl mx-auto mb-12">
            ...
            <p className="text-slate-400 text-sm mt-2">
              Dữ liệu di chuyển mượt mà giữa các mô-đun của hệ thống.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Tối ưu khối lượng, volume và nhịp nghỉ theo từng bài tập.",
              },
              {
                title: "Nutrition & Recovery",
                desc: "Macro rõ ràng, nhắc hydration và theo dõi giấc ngủ.",
              },
              {
                title: "AI Coach 24/7",
                desc: "Chat hỏi đáp nhanh, đề xuất thay thế bài tập và lịch phục hồi.",
              },
            ].map((eco, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-b from-white/8 to-white/2 border border-white/12 p-6 rounded-[20px] shadow-lg backdrop-blur-md space-y-3 hover:border-orange-500/30 transition-all"
              >
        ...
        <section
          id="cta"
          className="bg-gradient-to-b from-white/8 to-white/2 border border-white/12 p-8 md:p-12 rounded-[20px] shadow-2xl backdrop-blur-md flex flex-col md:flex-row justify-between items-center gap-8 mb-8"
        >
          <div className="space-y-2 text-center md:text-left">
            <h2 className="text-2xl md:text-4xl font-extrabold text-white">
              Gia nhập FitTrack ngay hôm nay
            </h2>
            <p className="text-slate-400 text-xs sm:text-sm">
              Premium dark mode. Dữ liệu cá nhân hoá. Tương tác mượt.
            </p>
          </div>
          <Link href="/dashboard/coach">
            <Button
              size="lg"
              className="bg-orange-500 hover:bg-orange-600 text-black font-bold px-8 py-5 rounded-full shadow-lg shadow-orange-500/20 active:scale-95 transition-transform shrink-0"
            >
      ...
      <footer className="border-t border-white/5 py-6 text-center text-slate-500 text-xs">
        <p>
          © {new Date().getFullYear()} FitTrack. Tất cả quyền được bảo lưu. Phát
          triển trên nền tảng thể thao khoa học.
        </p>
      </footer>
    </main>
  );
